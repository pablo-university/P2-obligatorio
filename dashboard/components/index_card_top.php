...
<div class="d-flex justify-content-around justify-content-md-start flex-wrap flex-xl-nowrap gap-3">
  <?php foreach ($values_for_get as $key => $value) { ?>
    <?php $res = $get_props_instance->count_value_in_true('products', $key)->fetch_object()->res; ?>
    <!-- <div class="col"> -->
    <div class="card flex-fill w-100 border-0 shadow-sm mb-3 p-0 hover-shadow-lg" style="max-width: 18rem;">
