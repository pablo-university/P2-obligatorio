<nav id="sidebarMenu" class="navba|r bg-dark navbar-dark | shadow-xl-light col-md-3 col-lg-2 d-md-block position-fixed z-index-1 collapse p-0 py-3 pb-5" style="height:100vh;">
  <!-- <div class="container-fluid"> -->

<!-- navbar-nav (tolera navbar-dark y light) ||| nav nav-pills | hice una mezcla!-->
  <ul class="navbar-nav nav-pills flex-column h-100">
    <li class="nav-item">
      <a class="nav-link | ps-4 <?= (str_contains(basename($_SERVER["REQUEST_URI"]), "index") ? 'active' : ''); ?>" aria-current="page" href="./index.php">
    ...
    <li class="nav-item">
      <a class="nav-link | ps-4 <?= (str_contains(basename($_SERVER["REQUEST_URI"]), "constructor") ? 'active' : ''); ?>" aria-current="page" href="./constructor.php">
    ...
    <li class="nav-item">
      <a class="nav-link | ps-4 <?= (str_contains(basename($_SERVER["REQUEST_URI"]), "list") ? 'active' : ''); ?>" aria-current="page" href="./list_update_delete.php">
